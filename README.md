...
### Manual Installation
1. Download the latest release from [GitHub Releases](https://github.com/bubble-wu/table-column-resizer/releases)
...
git clone https://github.com/bubble-wu/table-column-resizer.git
cd table-column-resizer
npm install
npm run build
```
